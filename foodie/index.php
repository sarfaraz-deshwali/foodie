...
<div class="d-md-flex flex-md-equal w-100 my-md-3 ps-md-3">
  <div class=" text-light bg-dark me-md-3 pt-3 px-5 pt-md-5 px-md-5 text-center overflow-hidden">
    ...
    <div class="bg-body shadow-sm mx-auto" style="width: 80%; height: 300px; border-radius: 21px 21px 0 0; background-image: url(https://www.vegetariantastebuds.com/wp-content/uploads/2020/10/NAVRATRI-VRAT-FASTING-MEAL-IDEAS-1.png);"></div>
  </div>
